# Generated by Powerlevel10k configuration wizard on 2023-07-27 at 12:43 CEST.
...
#################
# COMMENTED LINES (to disable/remove functionality that cannot be overriden by empty values)
#################
# typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
